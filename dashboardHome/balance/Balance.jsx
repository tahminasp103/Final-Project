    ...
    <>
      <div className={style.modalBackdrop}>
        <div className={style.balanceModal}>
          ...
          <p>Qalıq borc: {remaining > 0 ? `${remaining} ₺` : 'Yoxdur'}</p>

          {remaining > 0 && <p>⚠️ Balansınız çatmır, zəhmət olmasa artırın</p>}

          <div className={style.buttons}>
            <button onClick={onClose}>Geri qayıt</button>

            {remaining > 0 ? (
              <button onClick={() => setShowPay(true)}>Balans artır</button>
            ) : (
